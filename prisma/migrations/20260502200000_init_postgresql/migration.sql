...
-- CreateTable
CREATE TABLE IF NOT EXISTS "ArmyTroop" (
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "TrainQueue" (
    "id" TEXT NOT NULL,
    "villageId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "ArmyPosition" (
    "id" TEXT NOT NULL,
    "armyId" TEXT NOT NULL,
    "tileId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "SupplyLine" (
    "id" TEXT NOT NULL,
    "gameId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "SpyReport" (
    "id" TEXT NOT NULL,
    "gameId" TEXT NOT NULL,
    "tileId" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "Tile_gameId_x_y_key" ON "Tile"("gameId", "x", "y");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "Village_tileId_key" ON "Village"("tileId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "ArmyPosition_armyId_tileId_key" ON "ArmyPosition"("armyId", "tileId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "Camp_tileId_key" ON "Camp"("tileId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "Hero_gameId_key" ON "Hero"("gameId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "Hero_armyId_key" ON "Hero"("armyId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "HeroEquipment_heroId_slot_key" ON "HeroEquipment"("heroId", "slot");
